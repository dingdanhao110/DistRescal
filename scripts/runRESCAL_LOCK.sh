...
./runRESCAL_LOCK --n $n --n_e $n_e --show_loss $show_loss --opt $opt_method --d $dimension --margin $margin --step_size $step_size --lambdaA $lambdaA --lambdaR $lambdaR --epoch $epoch --p_epoch $p_epoch --o_epoch $o_epoch --t_path $train_file --v_path $valid_file --e_path $test_file
