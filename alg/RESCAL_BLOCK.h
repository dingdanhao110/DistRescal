...
#ifndef DISTRESCAL_RESCAL_BLOCK_H
#define DISTRESCAL_RESCAL_BLOCK_H
                ...
                computation_thread_pool->schedule(std::bind([&](const int thread_index) {
                    ...
                    for (int n = start; n < end; n++) {
                        ...
                        //update(sample);
                        {
                            ...
                            scheduler.insert_sample(sample,training_samples.size()-1);
                        }
                    }
                }, thread_index));
            }
...
public:
    explicit RESCAL_BLOCK<OptimizerType>(Parameter &parameter, Data &data) {
...
#endif //DISTRESCAL_RESCAL_BLOCK_H
