...
inline int split_relation(const vector<pair<int,int>>& heap_vec,const Parameter& parameter,unordered_set<int>& freq_entities){
    int split=heap_vec.size()-1;
    value_type thres=parameter.threshold_rel_freq;
