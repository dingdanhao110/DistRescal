...
//  data.output_decoder(parameter.output_path);
    ...
    if (parameter.optimization == "sgd") {
        RESCAL_POS<sgd> rescal_naive(parameter, data);
        rescal_naive.train();
    } else if (parameter.optimization == "adagrad") {
        RESCAL_POS<adagrad> rescal_naive(parameter, data);
        rescal_naive.train();
    } else if (parameter.optimization == "adadelta") {
        RESCAL_POS<adadelta> rescal_naive(parameter, data);
        rescal_naive.train();
    } else {
