...
#include "../alg/RESCAL_PREBATCH_REL.h"
...
//  data.output_decoder(parameter.output_path);
    ...
    if (parameter.optimization == "sgd") {
        RESCAL_PREBATCH_REL<sgd> rescal_lock(parameter, data);
        rescal_lock.train();
    } else if (parameter.optimization == "adagrad") {
        RESCAL_PREBATCH_REL<adagrad> rescal_lock(parameter, data);
        rescal_lock.train();
    } else if (parameter.optimization == "adadelta") {
        RESCAL_PREBATCH_REL<adadelta> rescal_lock(parameter, data);
        rescal_lock.train();
    } else {
